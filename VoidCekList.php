...
$sql = "SELECT e.nama_entitas, d.namabank, d.ac_number, dg.nocek, SUM(dg.Nominal) AS total_nominal, 
        ...
        WHERE dg.Statcek = 'Void' 
        AND MONTH(dg.tanggal_jatuh_tempo) = ? 
        AND YEAR(dg.tanggal_jatuh_tempo) = ?
        GROUP BY dg.tanggal_jatuh_tempo, e.nama_entitas, d.namabank, d.ac_number, dg.nocek, dg.TglVoid
...
// Initialize an array to hold Void cek records
$Void_cek_records = [];
while ($row = $result->fetch_assoc()) {
    $Void_cek_records[] = $row;
}
...
<body>
    <div class="container">
        <h1 class="text-center">Daftar cek Void</h1>
        <table class="table table-bordered table-striped">
            ...
            <?php else: ?>
                ...
                foreach ($Void_cek_records as $cek): 
                    // Update subtotal
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($cek['TglVoid']); ?></td> <!-- Kolom baru -->
