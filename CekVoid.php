...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($selected_nocek)) {
        ...
        $updateSql = "UPDATE detail_cek SET TglVoid = ?, Statcek = 'Void', VoidBy = ? WHERE nocek = ?";
        $stmt = $conn->prepare($updateSql);
        $stmt->bind_param("ssi", $TglVoid, $user_logged_in, $selected_nocek);
...
<body>
    ...
    <form action="" method="post">
        ...
        <label for="TglVoid">Tanggal Void cek:</label>
