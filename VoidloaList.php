...
foreach ($Void_loa_records as $loa) {
...
$total_records = count($Void_loa_records);
$records_per_page = 30;
$total_pages = ceil($total_records / $records_per_page);
$current_page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
$offset = ($current_page - 1) * $records_per_page;
$current_records = array_slice($Void_loa_records, $offset, $records_per_page);
...
<body>
    <div class="container" style="width:100%; max-width:2000px">
        <h1 class="text-center">Daftar loa Void</h1>
    ...
    <script>
        ...
        var reportData = <?php echo json_encode($Void_loa_records); ?>;
        let entity = {};
        ...
        function generatePDF() {
            ...
            doc.save(`Daftar loa Void - ${formattedDate}.pdf`);
        }
    </script>
