...
<head>
    ...
    <title>LAPORAN loa OUTSTANDING</title>
...
<body>
    <div class="header d-flex align-items-center" style="padding-top: 10px;">
        <a class="btn btn-primary d-flex align-items-center" href="/curdgiro/dashboard.php#loa" style="margin-right: 20px; transition: background-color 0.3s; border-radius: 50px; width: 130px;">
            <i class="bi bi-backspace" style="margin-right: 8px;"></i>
            Kembali
        </a>
        <h1 class="mb-0" style="line-height: 1; margin: 0;">LAPORAN loa OUTSTANDING </h1>
    </div>
