        ...
        <?php else: ?>
            <?php foreach ($records as $record): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($record['jenis_giro'] ?: $record['jenis_cek']); ?></td>
                    ...
                    <td>
                        <a href="edit.php?no=<?php echo urlencode($record['nogiro'] ?: $record['nocek']); ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="delete.php?no=<?php echo urlencode($record['nogiro'] ?: $record['nocek']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
