...
if (isset($data['nogiro'], $data['tanggal'], $data['statgiro'])) {
    $nogiro = $data['nogiro'];
    $tanggal = $data['tanggal'];
    $statgiro = $data['statgiro'];

    // Prepare the SQL statement
    $sql = "UPDATE detail_giro SET StatGiro = ?, TglVoid = ? WHERE nogiro = ?";
...
<body>
                ...
                ?>
                    <tr>
                        ...
                        <td>    
                            ...
                            <button class="btn btn-sm btn-info" id="return-btn"><i class="bi bi-backspace"></i></button>
                            <button class="btn btn-sm btn-danger" id="void-btn"><i class="bi bi-x-circle"></i></button>
    ...
    <script>
        document.querySelectorAll('.cair-btn').forEach(button => {
                ...
                if (date) {
                    ...
                    fetch('update_statgiro.php', {
                        ...
                        body: JSON.stringify({
                            ...
                            entitas: entitas,
                            tanggal: date,
                            statgiro: 'seatle' // Static value for this example
                        })
                    })
