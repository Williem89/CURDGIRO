            ...
            <?php else: ?>
                ...
                foreach ($Posted_giro_records as $giro): 
                    ...
                    if ($current_bank !== $giro['namabank']) {
                        ...
                        echo '<tr class="group-header"><td colspan="11">' . htmlspecialchars($current_bank) . '</td></tr>';
                    }
                ?>
                ...
                <tr class="subtotal"><td colspan="10">Subtotal</td><td><?php echo number_format($subtotal, 2, ',', '.'); ?></td></tr>
                <tr class="grand-total"><td colspan="10">Grand Total</td><td><?php echo number_format($grand_total, 2, ',', '.'); ?></td></tr>
            <?php endif; ?>
            </tbody>
        </table>
