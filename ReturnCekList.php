...
$sql = "SELECT e.nama_entitas, d.namabank, d.ac_number, dg.nocek, SUM(dg.Nominal) AS total_nominal, 
        ...
        WHERE dg.Statcek = 'Return' 
        GROUP BY dg.tanggal_jatuh_tempo, e.nama_entitas, d.namabank, d.ac_number, dg.nocek, dg.tglkembalikebank
...
// Initialize an array to hold Return cek records
$Return_cek_records = [];
while ($row = $result->fetch_assoc()) {
    $Return_cek_records[] = $row;
}
...
<body>
    <div class="container">
        <h1 class="text-center">Daftar cek Return</h1>
        <table class="table table-bordered table-striped">
            ...
            <tbody>
            <?php if (empty($Return_cek_records)): ?>
                <tr>
            ...
            <?php else: ?>
                ...
                foreach ($Return_cek_records as $cek): 
                    // Update subtotal
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($cek['tglkembalikebank']); ?></td> <!-- Kolom baru -->
