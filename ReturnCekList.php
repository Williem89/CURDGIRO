...
$total_records = count($Return_cek_records);
$records_per_page = 30;
$total_pages = ceil($total_records / $records_per_page);
$current_page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
$offset = ($current_page - 1) * $records_per_page;
$current_records = array_slice($Return_cek_records, $offset, $records_per_page);
...
<body>
    ...
    <script>
        ...
        var reportData = <?php echo json_encode($Return_cek_records); ?>;
        let entity = {};
        ...
        function generatePDF() {
            ...
            doc.save(`Daftar Cek Return - ${formattedDate}.pdf`);
        }
    </script>
